...
mysql -u $USER -p$USR_PASS $DB -e "UPDATE ps_configuration SET value = '${DOMAIN}' WHERE ps_configuration.`id_configuration` = 229;"
mysql -u $USER -p$USR_PASS $DB -e "UPDATE ps_configuration SET value = '${DOMAIN_SSL}' WHERE ps_configuration.`id_configuration` = 230;"
